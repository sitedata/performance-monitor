 ...
 * @subpackage Performance_Monitor/user-handler
...
class UserHandler extends WordPressHooks {
   ...
   * 'wp_performance-monitor-role-ROLENAME' meta_key items
  ...
  private function makeRoleQueryArgs( $role, $compare = 'EXISTS' ) {
    global $wpdb;
    $roleMetaPrefix = $wpdb->prefix . PERFORMANCE_MONITOR_KEY_PREFIX . 'r:';
